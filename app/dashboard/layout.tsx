...
import { Home, SlidersHorizontal, FolderOpen, CalendarDays, Inbox, ExternalLink, Users, Wand2 } from 'lucide-react'
...
const NAV = [
  ...
  { href: '/dashboard/create', label: 'Create Content', icon: <Wand2 size={15} /> },
